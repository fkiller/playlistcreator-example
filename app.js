(function(exports) {
	...
	if (location.host == 'localhost:8000') {
		client_id = '7aaea0cce0844148aafadd895675ac8d';
		redirect_uri = `http://${location.host}/callback.html`;
	} else {
	...
	var doLogin = function(callback) {
		var url = 'https://accounts.spotify.com/authorize?client_id=' + client_id +
			'&response_type=token' +
			'&scope=playlist-read-private%20playlist-modify%20playlist-modify-private%20user-follow-read%20user-follow-modify' +
